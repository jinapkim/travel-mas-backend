...
class UserModel(db.Model):
    ...
    experiences = db.relationship("ExperienceModel", backref="experiences", lazy="select")
    # trips = db.relationship("TripModel", backref="trips", lazy="dynamic")
    # ratings = db.relationship("RatingModel", backref="ratings", lazy="dynamic")
